...
p {	color:<?php echo $tirral_global['opt-typography-p']['color'];?>; font-style: <?php echo $tirral_global['opt-typography-p']['font-style'];?>; font-family: <?php echo $tirral_global['opt-typography-p']['font-family'];?>; font-size:<?php echo $tirral_global['opt-typography-p']['font-size'];?>; text-align:<?php echo $tirral_global['opt-typography-p']['text-align'];?>; line-height:<?php echo $tirral_global['opt-typography-p']['line-height'];?>; word-spacing:<?php echo $tirral_global['opt-typography-p']['word-spacing'];?>; letter-spacing:<?php echo $tirral_global['opt-typography-p']['letter-spacing'];?>;}		
.widget-area h2 { color:<?php echo $tirral_global['opt-typography-widget']['color'];?>; font-style: <?php echo $tirral_global['opt-typography-widget']['font-style'];?>; font-family: <?php echo $tirral_global['opt-typography-widget']['font-family'];?>; font-size:<?php echo $tirral_global['opt-typography-widget']['font-size'];?>; text-align:<?php echo $tirral_global['opt-typography-widget']['text-align'];?>; line-height:<?php echo $tirral_global['opt-typography-widget']['line-height'];?>; }
.widget-area a, .widget-area .textwidget, #calendar_wrap { color:<?php echo $tirral_global['opt-typography-a']['color'];?>;	font-style: <?php echo $tirral_global['opt-typography-a']['font-style'];?>; font-family: <?php echo $tirral_global['opt-typography-a']['font-family'];?>; font-size:<?php echo $tirral_global['opt-typography-a']['font-size'];?>; 	text-align:<?php echo $tirral_global['opt-typography-a']['text-align'];?>; line-height:<?php echo $tirral_global['opt-typography-a']['line-height'];?>; word-spacing:<?php echo $tirral_global['opt-typography-a']['word-spacing'];?>; letter-spacing:<?php echo $tirral_global['opt-typography-a']['letter-spacing'];?>;}
	
@media (max-width: 700px) {
h1 :not(a), h1.entry-title, h1.entry-title a, h1.page-title { font-size: 33px; line-height: 52px;} 
